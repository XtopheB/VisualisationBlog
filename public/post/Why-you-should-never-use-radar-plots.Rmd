...
If we focus on Thom and Johnny,  we clearly see that the sum of their scores is identical while there is a big difference in the area representing their scores. There is clearly a **lying factor** here (see [Tufte](https://www.edwardtufte.com/bboard/q-and-a-fetch-msg?msg_id=00002o) for a definition of this factor). The ranking of the total scores is not preserved by the graph, since in terms of areas we have the order from best to lowest: 
